...
from model_archs.styleClip import latent_mappers
from model_archs.styleClip.stylegan2.model import Generator
...
class StyleCLIPMapper(nn.Module):
    ...
    def __init__(self, opts):
        ...
        self.opts = opts
        # Define architecture
        self.mapper = latent_mappers.LevelsMapper(self.opts)
